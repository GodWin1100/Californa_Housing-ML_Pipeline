...
from housing.utils.utils import read_yaml_file
...
class Configuration:
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            data_ingestion_artifact_dir = os.path.join(self.artifact_dir, DATA_INGESTION_ARTIFACT_DIR, self.time_stamp)
            ...
            ingested_data_dir = os.path.join(
                data_ingestion_artifact_dir, data_ingestion_info[DATA_INGESTION_INGESTED_DIR_KEY]
            )
            ingested_train_dir = os.path.join(
                ingested_data_dir, data_ingestion_info[DATA_INGESTION_INGESTED_TRAIN_DIR_KEY]
            )
            ingested_test_dir = os.path.join(
                ingested_data_dir, data_ingestion_info[DATA_INGESTION_INGESTED_TEST_DIR_KEY]
            )
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        try:
            ...
            data_validation_artifact_dir = os.path.join(
                self.artifact_dir, DATA_VALIDATION_ARTIFACT_DIR, self.time_stamp
            )
            ...
            report_file_path = os.path.join(
                data_validation_artifact_dir, data_validation_info[DATA_VALIDATION_REPORT_FILE_NAME_KEY]
            )
            report_page_file_path = os.path.join(
                data_validation_artifact_dir, data_validation_info[DATA_VALIDATION_REPORT_PAGE_FILE_NAME_KEY]
            )
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            data_transformation_artifact_dir = os.path.join(
                self.artifact_dir, DATA_TRANSFORMATION_ARTIFACT_DIR, self.time_stamp
            )
            ...
            preprocess_object_file_path = os.path.join(
                data_transformation_artifact_dir,
            ...
            data_transformation_config = DataTransformationConfig(
                ...
                preprocess_object_file_path=preprocess_object_file_path,
            )
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            model_trainer_artifact_dir = os.path.join(self.artifact_dir, MODEL_TRAINER_ARTIFACT_DIR, self.time_stamp)
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        try:
            model_evaluation_artifact_dir = os.path.join(self.artifact_dir, MODEL_EVALUATION_ARTIFACT_DIR)
            model_evaluation_config = self.config_info[MODEL_EVALUATION_CONFIG_KEY]
            model_evaluation_file_path = os.path.join(
                model_evaluation_artifact_dir, model_evaluation_config[MODEL_EVALUATION_FILE_NAME_KEY]
            )
